...
// Add Stylesheets
$doc->addStyleSheet('templates/'.$this->template.'styles/animate.css');
$doc->addStyleSheet('templates/'.$this->template.'styles/ihover2.css');
$doc->addStyleSheet('templates/'.$this->template.'styles/jquery.lazyloadxt.fadein.css');
$doc->addStyleSheet('templates/'.$this->template.'styles/main2.css');
$doc->addStyleSheet('templates/'.$this->template.'styles/sprite-3.css');
...
<?php echo JText::_('TPL_vgj_BACKTOTOP');?>
</a>
      </p>
      <p>
        &copy;
